...
### Fixed
- Keep workflow child tool exposure aligned with advertised agent tools by recognizing current Pi builtins, activating required tools before the first child turn, and placing extension-repo managed worktrees outside Pi's extension auto-discovery directory (#2059).
