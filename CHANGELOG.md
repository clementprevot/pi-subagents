...
### Fixed
- Keep a parent from completing while a remembered detached foreground descendant is still in flight, and keep `hasOutstandingWork` / `bg_wait({ all: true })` aware of those descendants. Thanks to [@shaharmor](https://github.com/shaharmor) for #2051.
