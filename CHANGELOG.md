...
### Fixed
- Keep workflow child tool exposure aligned with advertised agent tools when auto-discovered extensions wrap Pi builtins, and place extension-repo managed worktrees outside Pi's extension auto-discovery directory (#2059).
